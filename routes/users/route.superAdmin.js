...
const { handleGetCustomer, handleGetCustomerByID, handleGetBuyer, handleGetSeller, handleGetSellerByID, handleGetBuyerByID } = require("../../controllers/users/controller.customer");
...
router.get("/customer/buyer/:buyer_id",superAdminVerifyToken,handleGetBuyerByID)
